...
# J, grad, theta1, theta2 = backprop(params, input_size, hidden_size, num_labels, X, y, learning_rate)
# print(J, grad.shape, h)
...
fmin = minimize(fun=backprop, x0=params, args=(input_size, hidden_size, num_labels, X, y, learning_rate), 
                method='TNC', jac=True, options={'maxiter': 10000, 'disp': True})
print(fmin)
